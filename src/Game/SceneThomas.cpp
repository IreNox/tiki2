...
namespace TikiEngine
{
	namespace Game
	{
		...
		SceneThomas::SceneThomas(Engine* engine)
			: Scene(engine)
		{

		}

		SceneThomas::~SceneThomas()
		{
			SafeRelease(&light);

		}

		void SceneThomas::Initialize(const InitializationArgs& args)
		{
	...
	/*		auto ha = TIKI_NEW AnimationHandlerResearchBuilding(go->GModel());
		...
		void SceneThomas::Draw(const DrawArgs& args)
		{
//#if TIKI_CULLING
...
//#endif
		...
		void SceneThomas::Update(const UpdateArgs& args)
		{
