...
#ifndef CLODDY_API_PROCEDURAL_NOISEFUNCTION_POWINV_H
#define CLODDY_API_PROCEDURAL_NOISEFUNCTION_POWINV_H
...
// Declare class ::Cloddy::API::Procedural::NoiseFunction_PowInv.
...
namespace Cloddy { namespace API { namespace Procedural
{
  ...
  class NoiseFunction_PowInv : public NoiseFunction_FS
  {
  ...
  public:
    ...
    /*!
     * @brief  Creates a new instance of NoiseFunction_PowInv.
     */
    NoiseFunction_PowInv();
  ...
  private:
    ...
    /*!
     * @brief  The GUID that uniquely identifies this type:{F8C64474-363E-49DA-9EF6-CB1EBF77FFEF}
     */
     ...
     */
    NoiseFunction_PowInv(INoiseFunction* function, float64 value);
     ...
     */
    public: typedef Ptr<NoiseFunction_PowInv> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x5E8E8E0F;
