...
#ifndef CLODDY_CORE_PARSING_RULE_ASTIFRIGHT_H
#define CLODDY_CORE_PARSING_RULE_ASTIFRIGHT_H
...
// Declare class ::Cloddy::Core::Parsing::Rule_AstIfRight.
...
namespace Cloddy { namespace Core { namespace Parsing
{
  ...
  template<class T>
  class Rule_AstIfRight : public RuleBase<T>
  {
  ...
  private:
    ...
    Rule_AstIfRight(IRule<T>* left, IRule<T>* right, TokenType* tokenType);
     ...
     */
    public: typedef Ptr<Rule_AstIfRight<T> > ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x98233E6F;
