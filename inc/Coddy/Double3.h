...
#ifndef CLODDY_API_VERTEXDATA_DOUBLE3_H
#define CLODDY_API_VERTEXDATA_DOUBLE3_H
...
// Declare class ::Cloddy::API::VertexData::Double3.
...
namespace Cloddy { namespace API { namespace VertexData
{
  ...
  /*!
   * @brief  Data container for application vertex data:three 64-bit floating-point values.
   */
  ...
  public:
     ...
     */
    public: typedef Ptr<Double3> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x7D48B3FA;
    ...
    protected: virtual void* TryCast(int typeId)
    {
      ...
      void* ptr;
      if ((ptr = Double2::TryCast(typeId)) != 0) return ptr;
      return (void*) 0;
    }
  };
