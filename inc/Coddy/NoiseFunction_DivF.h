...
#ifndef CLODDY_API_PROCEDURAL_NOISEFUNCTION_DIVF_H
#define CLODDY_API_PROCEDURAL_NOISEFUNCTION_DIVF_H
...
// Declare class ::Cloddy::API::Procedural::NoiseFunction_DivF.
...
namespace Cloddy { namespace API { namespace Procedural
{
  ...
  class NoiseFunction_DivF : public NoiseFunction_FF
  {
  ...
  public:
    ...
    /*!
     * @brief  Creates a new instance of NoiseFunction_DivF.
     */
    NoiseFunction_DivF();
  ...
  private:
    ...
    /*!
     * @brief  The GUID that uniquely identifies this type:{4A279FE0-9D21-4521-A0A2-409A4D1C6042}
     */
     ...
     * @brief  Creates a new instance of NoiseFunction_DivF.
     * 
     * @param first First inner noise function.
     * @param second Second inner noise function.
     */
    NoiseFunction_DivF(INoiseFunction* first, INoiseFunction* second);
     ...
     */
    public: typedef Ptr<NoiseFunction_DivF> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x367431EF;
