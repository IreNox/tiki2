...
#ifndef CLODDY_API_VERTEXFACTORIES_VERTEXFORMATS_VERTEXFORMAT_T3F_H
#define CLODDY_API_VERTEXFACTORIES_VERTEXFORMATS_VERTEXFORMAT_T3F_H
...
// Declare class ::Cloddy::API::VertexFactories::VertexFormats::VertexFormat_T3F.
...
namespace Cloddy { namespace API { namespace VertexFactories { namespace VertexFormats
{
  ...
  class VertexFormat_T3F : public VertexFormat
  {
  ...
  private:
    ...
    /*!
     * @brief  Scale factor for texture Z-coordinate.
     */
    float32 scaleZ;
    ...
    /*!
     * @brief  Creates a new instance of VertexFormat_T3F.
     * 
     ...
     */
    VertexFormat_T3F(float32 scaleX, float32 scaleY, float32 scaleZ);
     ...
     */
    public: typedef Ptr<VertexFormat_T3F> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x76FC8055;
