...
#ifndef CLODDY_API_HEIGHTMAPS_PROJECTION_MAPPROJECTION_MERCATOR_H
#define CLODDY_API_HEIGHTMAPS_PROJECTION_MAPPROJECTION_MERCATOR_H
...
// Declare class ::Cloddy::API::Heightmaps::Projection::MapProjection_Mercator.
...
namespace Cloddy { namespace API { namespace Heightmaps { namespace Projection
{
  ...
  class MapProjection_Mercator : public MapProjection
  {
  ...
  private:
    ...
    /*!
     * @brief  Creates a new instance of MapProjection_Mercator.
     * 
     ...
     */
    MapProjection_Mercator(float64 centerLongitude, int32 mapWidth, int32 mapHeight, int32 cubeSize);
     ...
     */
    public: typedef Ptr<MapProjection_Mercator> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xE81D2232;
