...
#ifndef CLODDY_CORE_COLLECTIONS_HASHDICTIONARY_ENTRIES_H
#define CLODDY_CORE_COLLECTIONS_HASHDICTIONARY_ENTRIES_H
...
// Declare class ::Cloddy::Core::Collections::HashDictionary_Entries.
...
namespace Cloddy { namespace Core { namespace Collections
{
  ...
  class HashDictionary_Entries : public CollectionConstBase<Val<DictionaryEntry<TKey, TValue> > >, public virtual ISetConst<Val<DictionaryEntry<TKey, TValue> > >
  {
  ...
  private:
     ...
     */
    HashDictionary_Entries(HashDictionary<TKey, TValue>* dictionary);
     ...
     */
    public: typedef Ptr<HashDictionary_Entries<TKey, TValue> > ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x8498AC3D;
