...
#ifndef CLODDY_API_VERTEXDATA_DOUBLE1_H
#define CLODDY_API_VERTEXDATA_DOUBLE1_H
...
#include "Cloddy/IVertexData.h"

// Include referenced classes.

#include "Cloddy/CapacityBase.h"

// Declare class ::Cloddy::API::VertexData::Double1.
...
namespace Cloddy { namespace API { namespace VertexData
{
  ...
  /*!
   * @brief  Data container for application vertex data:one 64-bit floating-point value.
   */
  class Double1 : public CapacityBase, public virtual IVertexData
  {
    // ---------------------------------------------------------------------------------------------
    // Public / Attributes
    // ---------------------------------------------------------------------------------------------
  public:
    ...
    virtual TupleType GetTupleType();
     ...
     */
    Double1(int32 capacity);
    
    // ---------------------------------------------------------------------------------------------
    // Public / Methods
    // ---------------------------------------------------------------------------------------------
    
    virtual int8 Get1B(int32 index);
    
    virtual float64 Get1D(int32 index);
    
    virtual float32 Get1F(int32 index);
    
    virtual int32 Get1I(int32 index);
    
    virtual int64 Get1L(int32 index);
    
    virtual int16 Get1S(int32 index);
     ...
     */
    public: typedef Ptr<Double1> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x7D48B3FC;
    ...
    protected: virtual void* TryCast(int typeId)
    {
      ...
      if ((ptr = IVertexData::TryCast(typeId)) != 0) return ptr;
      return (void*) 0;
    }
  };
