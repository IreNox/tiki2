...
#ifndef CLODDY_API_DATASETS_BUILDER_DATASETBLOCKFILTER_WITHOUT_H
#define CLODDY_API_DATASETS_BUILDER_DATASETBLOCKFILTER_WITHOUT_H
...
// Declare class ::Cloddy::API::Datasets::Builder::DatasetBlockFilter_WithOut.
...
namespace Cloddy { namespace API { namespace Datasets { namespace Builder
{
  ...
  class DatasetBlockFilter_WithOut : public DatasetBlockFilter
  {
  ...
  private:
    ...
    DatasetBlockFilter_WithOut(IDatasetBlockFilter* first, IDatasetBlockFilter* second);
     ...
     */
    public: typedef Ptr<DatasetBlockFilter_WithOut> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xEF90BC32;
