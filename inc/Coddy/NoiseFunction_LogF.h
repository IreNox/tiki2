...
#ifndef CLODDY_API_PROCEDURAL_NOISEFUNCTION_LOGF_H
#define CLODDY_API_PROCEDURAL_NOISEFUNCTION_LOGF_H
...
// Declare class ::Cloddy::API::Procedural::NoiseFunction_LogF.
...
namespace Cloddy { namespace API { namespace Procedural
{
  ...
  class NoiseFunction_LogF : public NoiseFunction_FF
  {
  ...
  public:
    ...
    /*!
     * @brief  Creates a new instance of NoiseFunction_LogF.
     */
    NoiseFunction_LogF();
  ...
  private:
    ...
    /*!
     * @brief  The GUID that uniquely identifies this type:{E488CC2B-E8BC-4357-92B8-272236F5FF38}
     */
     ...
     */
    NoiseFunction_LogF(INoiseFunction* first, INoiseFunction* second);
     ...
     */
    public: typedef Ptr<NoiseFunction_LogF> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xEEBCBC00;
