...
#ifndef CLODDY_API_VERTEXDATA_INT4_H
#define CLODDY_API_VERTEXDATA_INT4_H
...
// Declare class ::Cloddy::API::VertexData::Int4.
...
namespace Cloddy { namespace API { namespace VertexData
{
  ...
  /*!
   * @brief  Data container for application vertex data:four 32-bit integer values.
   */
  class Int4 : public Int3
  {
    // ---------------------------------------------------------------------------------------------
    // Public / Attributes
    // ---------------------------------------------------------------------------------------------
  public:
     ...
     */
    public: typedef Ptr<Int4> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xE93CD733;
    ...
    protected: virtual void* TryCast(int typeId)
    {
      ...
      void* ptr;
      if ((ptr = Int3::TryCast(typeId)) != 0) return ptr;
      return (void*) 0;
    }
  };
