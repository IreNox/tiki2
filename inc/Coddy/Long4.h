...
#ifndef CLODDY_API_VERTEXDATA_LONG4_H
#define CLODDY_API_VERTEXDATA_LONG4_H
...
// Declare class ::Cloddy::API::VertexData::Long4.
...
namespace Cloddy { namespace API { namespace VertexData
{
  ...
  /*!
   * @brief  Data container for application vertex data:four 64-bit integer values.
   */
  class Long4 : public Long3
  {
    // ---------------------------------------------------------------------------------------------
    // Public / Attributes
    // ---------------------------------------------------------------------------------------------
  public:
     ...
     */
    public: typedef Ptr<Long4> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xB3897A32;
    ...
    protected: virtual void* TryCast(int typeId)
    {
      ...
      void* ptr;
      if ((ptr = Long3::TryCast(typeId)) != 0) return ptr;
      return (void*) 0;
    }
  };
