...
#ifndef CLODDY_API_PROCEDURAL_NOISEFUNCTION_TRANSFORM3_H
#define CLODDY_API_PROCEDURAL_NOISEFUNCTION_TRANSFORM3_H
...
// Declare class ::Cloddy::API::Procedural::NoiseFunction_Transform3.
...
namespace Cloddy { namespace API { namespace Procedural
{
  ...
  class NoiseFunction_Transform3 : public NoiseFunction_F
  {
  ...
  public:
    ...
    /*!
     * @brief  Creates a new instance of NoiseFunction_Transform3.
     */
    NoiseFunction_Transform3();
  ...
  private:
    ...
    /*!
     * @brief  The GUID that uniquely identifies this type:{1A29FCBE-4DB2-4F89-B0C2-E339D0B0D348}
     */
     ...
     */
    NoiseFunction_Transform3(INoiseFunction* function, const Mat3D& matrix);
     ...
     */
    public: typedef Ptr<NoiseFunction_Transform3> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x41A5D381;
