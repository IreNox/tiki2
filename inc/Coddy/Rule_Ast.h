...
#ifndef CLODDY_CORE_PARSING_RULE_AST_H
#define CLODDY_CORE_PARSING_RULE_AST_H
...
// Declare class ::Cloddy::Core::Parsing::Rule_Ast.
...
namespace Cloddy { namespace Core { namespace Parsing
{
  ...
  template<class T>
  class Rule_Ast : public RuleBase<T>
  {
  ...
  private:
    ...
    Rule_Ast(IRule<T>* rule, TokenType* tokenType);
     ...
     */
    public: typedef Ptr<Rule_Ast<T> > ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x635833C6;
