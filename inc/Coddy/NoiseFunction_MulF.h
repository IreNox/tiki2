...
#ifndef CLODDY_API_PROCEDURAL_NOISEFUNCTION_MULF_H
#define CLODDY_API_PROCEDURAL_NOISEFUNCTION_MULF_H
...
// Declare class ::Cloddy::API::Procedural::NoiseFunction_MulF.
...
namespace Cloddy { namespace API { namespace Procedural
{
  ...
  class NoiseFunction_MulF : public NoiseFunction_FF
  {
  ...
  public:
    ...
    /*!
     * @brief  Creates a new instance of NoiseFunction_MulF.
     */
    NoiseFunction_MulF();
  ...
  private:
    ...
    /*!
     * @brief  The GUID that uniquely identifies this type:{E148B5DA-DF96-4493-87C2-1F11FB00D809}
     */
     ...
     */
    NoiseFunction_MulF(INoiseFunction* first, INoiseFunction* second);
     ...
     */
    public: typedef Ptr<NoiseFunction_MulF> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x35A16ABC;
