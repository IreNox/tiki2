...
#ifndef CLODDY_API_VERTEXDATA_LONG3_H
#define CLODDY_API_VERTEXDATA_LONG3_H
...
// Declare class ::Cloddy::API::VertexData::Long3.
...
namespace Cloddy { namespace API { namespace VertexData
{
  ...
  /*!
   * @brief  Data container for application vertex data:three 64-bit integer values.
   */
  class Long3 : public Long2
  {
    // ---------------------------------------------------------------------------------------------
    // Public / Attributes
    // ---------------------------------------------------------------------------------------------
  public:
     ...
     */
    public: typedef Ptr<Long3> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xB3897A39;
    ...
    protected: virtual void* TryCast(int typeId)
    {
      ...
      void* ptr;
      if ((ptr = Long2::TryCast(typeId)) != 0) return ptr;
      return (void*) 0;
    }
  };
