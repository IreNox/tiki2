...
#ifndef CLODDY_API_VERTEXDATA_FLOAT2_H
#define CLODDY_API_VERTEXDATA_FLOAT2_H
...
#include "Cloddy/Float1.h"

// Declare class ::Cloddy::API::VertexData::Float2.
...
namespace Cloddy { namespace API { namespace VertexData
{
  ...
  /*!
   * @brief  Data container for application vertex data:two 32-bit floating-point values.
   */
  class Float2 : public Float1
  {
    // ---------------------------------------------------------------------------------------------
    // Public / Attributes
    // ---------------------------------------------------------------------------------------------
  public:
     ...
     */
    public: typedef Ptr<Float2> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x9711C64C;
    ...
    protected: virtual void* TryCast(int typeId)
    {
      ...
      void* ptr;
      if ((ptr = Float1::TryCast(typeId)) != 0) return ptr;
      return (void*) 0;
    }
  };
