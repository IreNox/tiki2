...
#ifndef CLODDY_CORE_CONFIG_NUMBERTYPE_H
#define CLODDY_CORE_CONFIG_NUMBERTYPE_H
...
// Declare class ::Cloddy::Core::Config::NumberType.
...
namespace Cloddy { namespace Core { namespace Config
{
  ...
  /*!
   * @brief  Config property type:number (integer or float).
   */
  class NumberType : public Disposable, public virtual IConfigPropertyType
  {
    // ---------------------------------------------------------------------------------------------
    // Public / Attributes
    // ---------------------------------------------------------------------------------------------
  public:
    ...
    /*!
     * @brief  Singleton instance of NumberType.
     */
    static const StaticPtr<NumberType> Instance;
  ...
  private:
    ...
    /*!
     * @brief  Creates a new instance of NumberType.
     */
    NumberType();
     ...
     */
    public: typedef Ptr<NumberType> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x8ABF5516;
