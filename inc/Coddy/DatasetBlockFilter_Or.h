...
#ifndef CLODDY_API_DATASETS_BUILDER_DATASETBLOCKFILTER_OR_H
#define CLODDY_API_DATASETS_BUILDER_DATASETBLOCKFILTER_OR_H
...
// Declare class ::Cloddy::API::Datasets::Builder::DatasetBlockFilter_Or.
...
namespace Cloddy { namespace API { namespace Datasets { namespace Builder
{
  ...
  class DatasetBlockFilter_Or : public DatasetBlockFilter
  {
  ...
  private:
    ...
    DatasetBlockFilter_Or(IDatasetBlockFilter* first, IDatasetBlockFilter* second);
     ...
     */
    public: typedef Ptr<DatasetBlockFilter_Or> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xB5C0C397;
