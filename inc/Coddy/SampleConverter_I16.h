...
#ifndef CLODDY_API_HEIGHTMAPS_SAMPLEFORMATS_SAMPLECONVERTER_I16_H
#define CLODDY_API_HEIGHTMAPS_SAMPLEFORMATS_SAMPLECONVERTER_I16_H
...
// Declare class ::Cloddy::API::Heightmaps::SampleFormats::SampleConverter_I16.
...
namespace Cloddy { namespace API { namespace Heightmaps { namespace SampleFormats
{
  ...
  /*!
   * @brief  A sample format component for indexed diffuse color values stored in a two dataset 
   *         channels (ie. 16 bits).
   * 
   * The actual color value is derieved from the unsigned input value by using a color palette.
   */
  class SampleConverter_I16 : public SampleConverter
  {
  ...
  private:
    ...
    /*!
     * @brief  Creates a new instance of SampleConverter_I16.
     * 
     * @param colorPalette The color palette to use.
     * @param colorDistanceMetric The color distance metric to use.
     */
    SampleConverter_I16(Array<int32> colorPalette, IColorDistanceMetric* colorDistanceMetric);
     ...
     */
    public: typedef Ptr<SampleConverter_I16> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x5E190F37;
