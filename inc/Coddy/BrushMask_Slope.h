...
#ifndef CLODDY_API_HEIGHTMAPS_BRUSHES_BRUSHMASK_SLOPE_H
#define CLODDY_API_HEIGHTMAPS_BRUSHES_BRUSHMASK_SLOPE_H
...
// Declare class ::Cloddy::API::Heightmaps::Brushes::BrushMask_Slope.
...
namespace Cloddy { namespace API { namespace Heightmaps { namespace Brushes
{
  ...
  /*!
   * @brief  An implementation of the IBrushMask that computes mask values from the slope and 
   *         elevation of the terrain.
   */
  class BrushMask_Slope : public BrushMask
  {
  ...
  private:
    ...
    /*!
     * @brief  The weight curve for slope values.
     */
    Gauss curve;
    
    /*!
     * @brief  The slope buffer offset.
     */
    int32 offset;
    ...
    BrushMask_Slope(int32 width, int32 height, const Gauss& curve);
     ...
     */
    public: typedef Ptr<BrushMask_Slope> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x7326C510;
