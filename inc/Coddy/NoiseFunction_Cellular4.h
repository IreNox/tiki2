...
#ifndef CLODDY_API_PROCEDURAL_NOISEFUNCTION_CELLULAR4_H
#define CLODDY_API_PROCEDURAL_NOISEFUNCTION_CELLULAR4_H
...
// Declare class ::Cloddy::API::Procedural::NoiseFunction_Cellular4.
...
namespace Cloddy { namespace API { namespace Procedural
{
  ...
  class NoiseFunction_Cellular4 : public NoiseFunction
  {
  ...
  public:
    ...
    /*!
     * @brief  Creates a new instance of NoiseFunction_Cellular4.
     */
    NoiseFunction_Cellular4();
  ...
  private:
    ...
    /*!
     * @brief  The GUID that uniquely identifies this type:{02E30EEC-E2BA-4DE5-84F6-F869D6847F0B}
     */
     ...
     */
    Ptr<ICellularCombiner> combiner;
    ...
    /*!
     * @brief  Creates a new instance of NoiseFunction_Cellular3.
     * 
     * @param combiner The combiner function.
     */
    NoiseFunction_Cellular4(ICellularCombiner* combiner);
     ...
     */
    public: typedef Ptr<NoiseFunction_Cellular4> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xDA24BFBA;
