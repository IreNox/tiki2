...
#ifndef CLODDY_API_PROCEDURAL_NOISEFUNCTION_PERLIN_H
#define CLODDY_API_PROCEDURAL_NOISEFUNCTION_PERLIN_H
...
// Declare class ::Cloddy::API::Procedural::NoiseFunction_Perlin.
...
namespace Cloddy { namespace API { namespace Procedural
{
  ...
  /*!
   * @brief  A noise functions that computes simplex based perlin noise.
   */
  class NoiseFunction_Perlin : public NoiseFunction
  {
    // ---------------------------------------------------------------------------------------------
    // Public / Constructors
    // ---------------------------------------------------------------------------------------------
  public:
    ...
    /*!
     * @brief  Creates a new instance of NoiseFunction_Perlin.
     */
  ...
  private:
    ...
    /*!
     * @brief  The GUID that uniquely identifies this type:{625C896C-70AA-4BEF-8ABC-DE5EFDB37688}
     */
     ...
     */
    public: typedef Ptr<NoiseFunction_Perlin> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xDD6F720E;
