...
#ifndef CLODDY_API_HEIGHTMAPS_SAMPLEFORMATS_SAMPLECONVERTER_D24_H
#define CLODDY_API_HEIGHTMAPS_SAMPLEFORMATS_SAMPLECONVERTER_D24_H
...
// Declare class ::Cloddy::API::Heightmaps::SampleFormats::SampleConverter_D24.
...
namespace Cloddy { namespace API { namespace Heightmaps { namespace SampleFormats
{
  ...
  /*!
   * @brief  A sample format component for displacement values stored in three dataset channels (
   *         ie. 24 bits XYZ).
   */
  class SampleConverter_D24 : public SampleConverter
  {
  ...
  private:
    ...
    /*!
     * @brief  Creates a new instance of SampleConverter_D24.
     */
    SampleConverter_D24();
     ...
     */
    public: typedef Ptr<SampleConverter_D24> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x460F6E6F;
