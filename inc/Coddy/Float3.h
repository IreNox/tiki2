...
#ifndef CLODDY_API_VERTEXDATA_FLOAT3_H
#define CLODDY_API_VERTEXDATA_FLOAT3_H
...
// Declare class ::Cloddy::API::VertexData::Float3.
...
namespace Cloddy { namespace API { namespace VertexData
{
  ...
  /*!
   * @brief  Data container for application vertex data:three 32-bit floating-point values.
   */
  ...
  public:
     ...
     */
    public: typedef Ptr<Float3> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x39B93AE7;
    ...
    protected: virtual void* TryCast(int typeId)
    {
      ...
      void* ptr;
      if ((ptr = Float2::TryCast(typeId)) != 0) return ptr;
      return (void*) 0;
    }
  };
