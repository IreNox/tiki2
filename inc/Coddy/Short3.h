...
#ifndef CLODDY_API_VERTEXDATA_SHORT3_H
#define CLODDY_API_VERTEXDATA_SHORT3_H
...
// Declare class ::Cloddy::API::VertexData::Short3.
...
namespace Cloddy { namespace API { namespace VertexData
{
  ...
  /*!
   * @brief  Data container for application vertex data:three 16-bit integer values.
   */
  class Short3 : public Short2
  {
    // ---------------------------------------------------------------------------------------------
    // Public / Attributes
    // ---------------------------------------------------------------------------------------------
  public:
     ...
     */
    public: typedef Ptr<Short3> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x747FEB65;
    ...
    protected: virtual void* TryCast(int typeId)
    {
      ...
      void* ptr;
      if ((ptr = Short2::TryCast(typeId)) != 0) return ptr;
      return (void*) 0;
    }
  };
