...
#ifndef CLODDY_API_PROCEDURAL_CELLULARCOMBINER_F3_H
#define CLODDY_API_PROCEDURAL_CELLULARCOMBINER_F3_H
...
// Declare class ::Cloddy::API::Procedural::CellularCombiner_F3.
...
namespace Cloddy { namespace API { namespace Procedural
{
  ...
  class CellularCombiner_F3 : public CellularCombiner
  {
    // ---------------------------------------------------------------------------------------------
    // Public / Constructors
    // ---------------------------------------------------------------------------------------------
  public:
    ...
    /*!
     * @brief  Creates a new instance of CellularCombiner_F3.
     */
    CellularCombiner_F3();
  ...
  private:
    ...
    /*!
     * @brief  The GUID that uniquely identifies this type:{CB6F2A67-CE2C-49B0-B0BF-A8F809FBD231}
     */
     ...
     */
    public: typedef Ptr<CellularCombiner_F3> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xC1DDC012;
