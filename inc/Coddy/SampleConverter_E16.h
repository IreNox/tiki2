...
#ifndef CLODDY_API_HEIGHTMAPS_SAMPLEFORMATS_SAMPLECONVERTER_E16_H
#define CLODDY_API_HEIGHTMAPS_SAMPLEFORMATS_SAMPLECONVERTER_E16_H
...
// Declare class ::Cloddy::API::Heightmaps::SampleFormats::SampleConverter_E16.
...
namespace Cloddy { namespace API { namespace Heightmaps { namespace SampleFormats
{
  ...
  /*!
   * @brief  A sample format component for elevation values stored in two dataset channels (ie. 16 
   *         bits).
   */
  class SampleConverter_E16 : public SampleConverter
  {
  ...
  private:
    ...
    /*!
     * @brief  Creates a new instance of SampleConverter_E16.
     */
    SampleConverter_E16();
     ...
     */
    public: typedef Ptr<SampleConverter_E16> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x5E1910BB;
