...
#ifndef CLODDY_API_VERTEXFACTORIES_VERTEXFORMATS_VERTEXFORMAT_P3F_H
#define CLODDY_API_VERTEXFACTORIES_VERTEXFORMATS_VERTEXFORMAT_P3F_H
...
// Declare class ::Cloddy::API::VertexFactories::VertexFormats::VertexFormat_P3F.
...
namespace Cloddy { namespace API { namespace VertexFactories { namespace VertexFormats
{
  ...
  class VertexFormat_P3F : public VertexFormat
  {
  ...
  private:
    ...
    /*!
     * @brief  Creates a new instance of VertexFormat_P3F.
     */
    VertexFormat_P3F();
     ...
     */
    public: typedef Ptr<VertexFormat_P3F> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x76FC80D1;
