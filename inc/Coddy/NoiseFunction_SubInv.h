...
#ifndef CLODDY_API_PROCEDURAL_NOISEFUNCTION_SUBINV_H
#define CLODDY_API_PROCEDURAL_NOISEFUNCTION_SUBINV_H
...
// Declare class ::Cloddy::API::Procedural::NoiseFunction_SubInv.
...
namespace Cloddy { namespace API { namespace Procedural
{
  ...
  class NoiseFunction_SubInv : public NoiseFunction_FS
  {
  ...
  public:
    ...
    /*!
     * @brief  Creates a new instance of NoiseFunction_SubInv.
     */
    NoiseFunction_SubInv();
  ...
  private:
    ...
    /*!
     * @brief  The GUID that uniquely identifies this type:{FC4212B8-28DB-48F4-B300-024A97239F03}
     */
     ...
     */
    NoiseFunction_SubInv(INoiseFunction* function, float64 value);
     ...
     */
    public: typedef Ptr<NoiseFunction_SubInv> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x774551B;
