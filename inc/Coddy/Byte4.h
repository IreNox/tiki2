...
#ifndef CLODDY_API_VERTEXDATA_BYTE4_H
#define CLODDY_API_VERTEXDATA_BYTE4_H
...
// Declare class ::Cloddy::API::VertexData::Byte4.
...
namespace Cloddy { namespace API { namespace VertexData
{
  ...
  /*!
   * @brief  Data container for application vertex data:four 8-bit integer values.
   */
  class Byte4 : public Byte3
  {
    // ---------------------------------------------------------------------------------------------
    // Public / Attributes
    // ---------------------------------------------------------------------------------------------
  public:
     ...
     */
    public: typedef Ptr<Byte4> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xF86F1AEA;
    ...
    protected: virtual void* TryCast(int typeId)
    {
      ...
      void* ptr;
      if ((ptr = Byte3::TryCast(typeId)) != 0) return ptr;
      return (void*) 0;
    }
  };
