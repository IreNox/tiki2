...
#ifndef CLODDY_API_HEIGHTMAPS_SAMPLEFORMATS_SAMPLECONVERTER_D48_H
#define CLODDY_API_HEIGHTMAPS_SAMPLEFORMATS_SAMPLECONVERTER_D48_H
...
// Declare class ::Cloddy::API::Heightmaps::SampleFormats::SampleConverter_D48.
...
namespace Cloddy { namespace API { namespace Heightmaps { namespace SampleFormats
{
  ...
  /*!
   * @brief  A sample format component for displacement values stored in six dataset channels (ie. 
   *         48 bits XYZ).
   */
  class SampleConverter_D48 : public SampleConverter
  {
  ...
  private:
    ...
    /*!
     * @brief  Creates a new instance of SampleConverter_D48.
     */
    SampleConverter_D48();
     ...
     */
    public: typedef Ptr<SampleConverter_D48> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x8B5E57A1;
