...
#ifndef CLODDY_API_PROCEDURAL_NOISEFUNCTION_CELLULAR3_H
#define CLODDY_API_PROCEDURAL_NOISEFUNCTION_CELLULAR3_H
...
// Declare class ::Cloddy::API::Procedural::NoiseFunction_Cellular3.
...
namespace Cloddy { namespace API { namespace Procedural
{
  ...
  class NoiseFunction_Cellular3 : public NoiseFunction
  {
  ...
  private:
    ...
    /*!
     * @brief  The GUID that uniquely identifies this type:{993310C1-D054-43BC-A21F-16453CF0C614}
     */
     ...
     */
    NoiseFunction_Cellular3(ICellularCombiner* combiner);
     ...
     */
    public: typedef Ptr<NoiseFunction_Cellular3> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xDA24BFC1;
