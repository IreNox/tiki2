...
#ifndef CLODDY_API_VERTEXDATA_DOUBLE4_H
#define CLODDY_API_VERTEXDATA_DOUBLE4_H
...
// Declare class ::Cloddy::API::VertexData::Double4.
...
namespace Cloddy { namespace API { namespace VertexData
{
  ...
  /*!
   * @brief  Data container for application vertex data:four 64-bit floating-point values.
   */
  ...
  public:
     ...
     */
    public: typedef Ptr<Double4> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x7D48B401;
    ...
    protected: virtual void* TryCast(int typeId)
    {
      ...
      void* ptr;
      if ((ptr = Double3::TryCast(typeId)) != 0) return ptr;
      return (void*) 0;
    }
  };
