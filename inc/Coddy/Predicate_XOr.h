...
#ifndef CLODDY_CORE_COLLECTIONS_PREDICATE_XOR_H
#define CLODDY_CORE_COLLECTIONS_PREDICATE_XOR_H
...
// Declare class ::Cloddy::Core::Collections::Predicate_XOr.
...
namespace Cloddy { namespace Core { namespace Collections
{
  ...
  template<class T>
  class Predicate_XOr : public PredicateBase<T>
  {
  ...
  private:
    ...
    Predicate_XOr(IPredicate<T>* first, IPredicate<T>* second);
     ...
     */
    public: typedef Ptr<Predicate_XOr<T> > ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xEE5B6155;
