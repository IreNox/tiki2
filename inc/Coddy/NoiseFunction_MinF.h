...
#ifndef CLODDY_API_PROCEDURAL_NOISEFUNCTION_MINF_H
#define CLODDY_API_PROCEDURAL_NOISEFUNCTION_MINF_H
...
// Declare class ::Cloddy::API::Procedural::NoiseFunction_MinF.
...
namespace Cloddy { namespace API { namespace Procedural
{
  ...
  class NoiseFunction_MinF : public NoiseFunction_FF
  {
  ...
  public:
    ...
    /*!
     * @brief  Creates a new instance of NoiseFunction_MinF.
     */
    NoiseFunction_MinF();
  ...
  private:
    ...
    /*!
     * @brief  The GUID that uniquely identifies this type:{B1CEB014-E28F-40C7-B37D-93B775B35D75}
     */
     ...
     */
    NoiseFunction_MinF(INoiseFunction* first, INoiseFunction* second);
     ...
     */
    public: typedef Ptr<NoiseFunction_MinF> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x3674301E;
