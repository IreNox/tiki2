...
#ifndef CLODDY_API_VERTEXDATA_DOUBLE2_H
#define CLODDY_API_VERTEXDATA_DOUBLE2_H
...
#include "Cloddy/Double1.h"

// Declare class ::Cloddy::API::VertexData::Double2.
...
namespace Cloddy { namespace API { namespace VertexData
{
  ...
  /*!
   * @brief  Data container for application vertex data:two 64-bit floating-point values.
   */
  ...
  public:
     ...
     */
    public: typedef Ptr<Double2> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x7D48B3FB;
    ...
    protected: virtual void* TryCast(int typeId)
    {
      ...
      void* ptr;
      if ((ptr = Double1::TryCast(typeId)) != 0) return ptr;
      return (void*) 0;
    }
  };
