...
#ifndef CLODDY_API_PROCEDURAL_NOISEFUNCTION_LOGINV_H
#define CLODDY_API_PROCEDURAL_NOISEFUNCTION_LOGINV_H
...
// Declare class ::Cloddy::API::Procedural::NoiseFunction_LogInv.
...
namespace Cloddy { namespace API { namespace Procedural
{
  ...
  class NoiseFunction_LogInv : public NoiseFunction_FS
  {
  ...
  public:
    ...
    /*!
     * @brief  Creates a new instance of NoiseFunction_LogInv.
     */
    NoiseFunction_LogInv();
  ...
  private:
    ...
    /*!
     * @brief  The GUID that uniquely identifies this type:{C50192D3-D9C9-423D-B96F-3EA3E334E332}
     */
     ...
     */
    NoiseFunction_LogInv(INoiseFunction* function, float64 value);
     ...
     */
    public: typedef Ptr<NoiseFunction_LogInv> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x5E8E9E13;
