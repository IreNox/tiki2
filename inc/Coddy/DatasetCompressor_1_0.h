...
#ifndef CLODDY_API_DATASETS_DATASETCOMPRESSOR_1_0_H
#define CLODDY_API_DATASETS_DATASETCOMPRESSOR_1_0_H
...
// Declare class ::Cloddy::API::Datasets::DatasetCompressor_1_0.
...
namespace Cloddy { namespace API { namespace Datasets
{
  ...
  /*!
   * @brief  An implementation of the IOperation interface that compresses a dataset of version 1.0.
   */
  class DatasetCompressor_1_0 : public Operation
  {
  ...
  private:
    ...
    /*!
     * @brief  Creates a new instance of DatasetCompressor_1_0.
     * 
     * @param inputDataset The input dataset.
     * @param outputDatasetFilePath The file path to the output dataset.
     */
    DatasetCompressor_1_0(IDataset* inputDataset, Path* outputDatasetFilePath);
    ...
    /*!
     * @brief  Compresses a dataset that uses a square as base geometry.
     * 
     * @param outputDataset The output dataset file.
     * @param progressMonitor The progress monitor.
     */
    void CompressCube(IDatafile* outputDataset, IProgressMonitor* progressMonitor);
     ...
     * @param progressMonitor The progress monitor.
     */
    void CompressRect(IDatafile* outputDataset, IProgressMonitor* progressMonitor);
     ...
     */
    public: typedef Ptr<DatasetCompressor_1_0> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xF17D4CD9;
