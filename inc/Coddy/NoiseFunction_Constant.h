...
#ifndef CLODDY_API_PROCEDURAL_NOISEFUNCTION_CONSTANT_H
#define CLODDY_API_PROCEDURAL_NOISEFUNCTION_CONSTANT_H
...
// Declare class ::Cloddy::API::Procedural::NoiseFunction_Constant.
...
namespace Cloddy { namespace API { namespace Procedural
{
  ...
  class NoiseFunction_Constant : public NoiseFunction
  {
  ...
  public:
    ...
    /*!
     * @brief  Creates a new instance of NoiseFunction_Constant.
     */
    NoiseFunction_Constant();
  ...
  private:
    ...
    /*!
     * @brief  The GUID that uniquely identifies this type:{584C43A3-0706-4470-A17B-6C2A221D1085}
     */
     ...
     */
    NoiseFunction_Constant(float64 value);
     ...
     */
    public: typedef Ptr<NoiseFunction_Constant> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x8AC76F94;
