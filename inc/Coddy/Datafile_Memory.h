...
#ifndef CLODDY_API_DATAFILES_DATAFILE_MEMORY_H
#define CLODDY_API_DATAFILES_DATAFILE_MEMORY_H
...
namespace Cloddy { namespace API { namespace Datafiles { class DatafileFactory_Memory; } } }
namespace Cloddy { namespace Core { namespace IO { namespace Files { class Path; } } } }
namespace CodeX { namespace System { class ByteBuffer; } }

// Declare class ::Cloddy::API::Datafiles::Datafile_Memory.
...
namespace Cloddy { namespace API { namespace Datafiles
{
  ...
  class Datafile_Memory : public DatafileBase
  {
    // Declare friend classes.
    
    friend class DatafileFactory_Memory;
  ...
  private:
     ...
     */
    public: typedef Ptr<Datafile_Memory> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x85EBE49D;
