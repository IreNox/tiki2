...
#ifndef CLODDY_API_HEIGHTMAPS_FRACTAL_FRACTALLAYER_DETAIL0_H
#define CLODDY_API_HEIGHTMAPS_FRACTAL_FRACTALLAYER_DETAIL0_H
...
// Declare class ::Cloddy::API::Heightmaps::Fractal::FractalLayer_Detail0.
...
namespace Cloddy { namespace API { namespace Heightmaps { namespace Fractal
{
  ...
  class FractalLayer_Detail0 : public FractalLayer
  {
  ...
  private:
    ...
    FractalLayer_Detail0(INoiseFunction* a, INoiseFunction* b, INoiseFunction* c, INoiseFunction* d, IFractalDiffuseCombiner* combiner);
     ...
     */
    public: typedef Ptr<FractalLayer_Detail0> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x765DF04B;
