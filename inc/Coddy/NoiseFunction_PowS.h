...
#ifndef CLODDY_API_PROCEDURAL_NOISEFUNCTION_POWS_H
#define CLODDY_API_PROCEDURAL_NOISEFUNCTION_POWS_H
...
// Declare class ::Cloddy::API::Procedural::NoiseFunction_PowS.
...
namespace Cloddy { namespace API { namespace Procedural
{
  ...
  class NoiseFunction_PowS : public NoiseFunction_FS
  {
  ...
  public:
    ...
    /*!
     * @brief  Creates a new instance of NoiseFunction_PowS.
     */
    NoiseFunction_PowS();
  ...
  private:
    ...
    /*!
     * @brief  The GUID that uniquely identifies this type:{78F908CF-6952-47A3-8271-E394D1DAA691}
     */
     ...
     */
    NoiseFunction_PowS(INoiseFunction* function, float64 value);
     ...
     */
    public: typedef Ptr<NoiseFunction_PowS> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x12A6305;
