...
#ifndef CLODDY_API_DATASETS_DATASET_1_0_CUBE_COMPRESSED_H
#define CLODDY_API_DATASETS_DATASET_1_0_CUBE_COMPRESSED_H
...
// Declare class ::Cloddy::API::Datasets::Dataset_1_0_Cube_Compressed.
...
namespace Cloddy { namespace API { namespace Datasets
{
   ...
   */
  class Dataset_1_0_Cube_Compressed : public Dataset
  {
  ...
  private:
    ...
    /*!
     * @brief  Creates a new instance of Dataset_1_0_Cube_Compressed.
     * 
     * @param datafile The underlying datafile.
     */
    Dataset_1_0_Cube_Compressed(IDatafile* datafile);
     ...
     */
    public: typedef Ptr<Dataset_1_0_Cube_Compressed> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x9E64B9C0;
