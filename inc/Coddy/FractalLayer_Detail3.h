...
#ifndef CLODDY_API_HEIGHTMAPS_FRACTAL_FRACTALLAYER_DETAIL3_H
#define CLODDY_API_HEIGHTMAPS_FRACTAL_FRACTALLAYER_DETAIL3_H
...
// Declare class ::Cloddy::API::Heightmaps::Fractal::FractalLayer_Detail3.
...
namespace Cloddy { namespace API { namespace Heightmaps { namespace Fractal
{
  ...
  class FractalLayer_Detail3 : public FractalLayer
  {
  ...
  private:
    ...
    FractalLayer_Detail3(INoiseFunction* a, INoiseFunction* b, INoiseFunction* c, INoiseFunction* d, IFractalDiffuseCombiner* combiner);
     ...
     */
    public: typedef Ptr<FractalLayer_Detail3> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x5E544E1C;
