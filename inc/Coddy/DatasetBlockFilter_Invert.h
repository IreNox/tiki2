...
#ifndef CLODDY_API_DATASETS_BUILDER_DATASETBLOCKFILTER_INVERT_H
#define CLODDY_API_DATASETS_BUILDER_DATASETBLOCKFILTER_INVERT_H
...
// Declare class ::Cloddy::API::Datasets::Builder::DatasetBlockFilter_Invert.
...
namespace Cloddy { namespace API { namespace Datasets { namespace Builder
{
  ...
  class DatasetBlockFilter_Invert : public DatasetBlockFilter
  {
  ...
  private:
    ...
    DatasetBlockFilter_Invert(IDatasetBlockFilter* filter);
     ...
     */
    public: typedef Ptr<DatasetBlockFilter_Invert> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x86546086;
