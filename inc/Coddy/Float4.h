...
#ifndef CLODDY_API_VERTEXDATA_FLOAT4_H
#define CLODDY_API_VERTEXDATA_FLOAT4_H
...
// Declare class ::Cloddy::API::VertexData::Float4.
...
namespace Cloddy { namespace API { namespace VertexData
{
  ...
  /*!
   * @brief  Data container for application vertex data:four 32-bit floating-point values.
   */
  ...
  public:
     ...
     */
    public: typedef Ptr<Float4> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xDC60AF82;
    ...
    protected: virtual void* TryCast(int typeId)
    {
      ...
      void* ptr;
      if ((ptr = Float3::TryCast(typeId)) != 0) return ptr;
      return (void*) 0;
    }
  };
