...
#ifndef CLODDY_API_HEIGHTMAPS_SAMPLEFORMATS_SAMPLECONVERTER_X128_H
#define CLODDY_API_HEIGHTMAPS_SAMPLEFORMATS_SAMPLECONVERTER_X128_H
...
// Declare class ::Cloddy::API::Heightmaps::SampleFormats::SampleConverter_X128.
...
namespace Cloddy { namespace API { namespace Heightmaps { namespace SampleFormats
{
  ...
  class SampleConverter_X128 : public SampleConverter
  {
  ...
  private:
     ...
     */
    public: typedef Ptr<SampleConverter_X128> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x144B863C;
