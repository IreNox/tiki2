...
#ifndef CLODDY_API_TOOLS_BUILDBLOCKTOOL_H
#define CLODDY_API_TOOLS_BUILDBLOCKTOOL_H
...
// Declare class ::Cloddy::API::Tools::BuildBlockTool.
...
namespace Cloddy { namespace API { namespace Tools
{
  ...
  using Cloddy::API::Datasets::Builder::IDatasetBlockProvider;
  ...
  class BuildBlockTool : public Tool
  {
    // ---------------------------------------------------------------------------------------------
    // Public / Attributes
    // ---------------------------------------------------------------------------------------------
  public:
    ...
    void SetBlock(const Vec2I& value);
    
    Ptr<IDataset> GetDataset();
    
    void SetDataset(IDataset* value);
    
    virtual String GetName();
    
    Ptr<IDatasetBlockProvider> GetProvider();
    
    void SetProvider(IDatasetBlockProvider* value);
  ...
  private:
    ...
    /*!
     * @brief  The GUID that uniquely identifies this type:{D6B713B8-C08B-4859-95A7-A83EC6CD2A38}
     */
     ...
     */
    public: typedef Ptr<BuildBlockTool> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x62517284;
