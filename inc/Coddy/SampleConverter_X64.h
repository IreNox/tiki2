...
#ifndef CLODDY_API_HEIGHTMAPS_SAMPLEFORMATS_SAMPLECONVERTER_X64_H
#define CLODDY_API_HEIGHTMAPS_SAMPLEFORMATS_SAMPLECONVERTER_X64_H
...
// Declare class ::Cloddy::API::Heightmaps::SampleFormats::SampleConverter_X64.
...
namespace Cloddy { namespace API { namespace Heightmaps { namespace SampleFormats
{
  ...
  class SampleConverter_X64 : public SampleConverter
  {
  ...
  private:
     ...
     */
    public: typedef Ptr<SampleConverter_X64> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xD0AD4147;
