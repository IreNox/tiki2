...
#ifndef CLODDY_CORE_PARSING_TOKENRULE_EXCEPT_H
#define CLODDY_CORE_PARSING_TOKENRULE_EXCEPT_H
...
// Declare class ::Cloddy::Core::Parsing::TokenRule_Except.
...
namespace Cloddy { namespace Core { namespace Parsing
{
  ...
  template<class T>
  class TokenRule_Except : public TokenRuleBase<T>
  {
  ...
  private:
    ...
    TokenRule_Except(ITokenRule<T>* first, ITokenRule<T>* second);
     ...
     */
    public: typedef Ptr<TokenRule_Except<T> > ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x7DD918B2;
