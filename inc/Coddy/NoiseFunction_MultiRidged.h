...
#ifndef CLODDY_API_PROCEDURAL_NOISEFUNCTION_MULTIRIDGED_H
#define CLODDY_API_PROCEDURAL_NOISEFUNCTION_MULTIRIDGED_H
...
// Declare class ::Cloddy::API::Procedural::NoiseFunction_MultiRidged.
...
namespace Cloddy { namespace API { namespace Procedural
{
  ...
  class NoiseFunction_MultiRidged : public NoiseFunction_Multi
  {
  ...
  public:
    ...
    /*!
     * @brief  Creates a new instance of NoiseFunction_MultiRidged.
     */
    NoiseFunction_MultiRidged();
  ...
  private:
    ...
    /*!
     * @brief  The GUID that uniquely identifies this type:{04A1D1CA-8A3D-4E15-A6C2-656896D5BB0E}
     */
     ...
     */
    NoiseFunction_MultiRidged(int32 octaves, float64 amplitude, float64 frequency, float64 gain, float64 offset, INoiseFunction* inner);
     ...
     */
    public: typedef Ptr<NoiseFunction_MultiRidged> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xCFD8CE00;
