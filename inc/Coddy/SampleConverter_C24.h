...
#ifndef CLODDY_API_HEIGHTMAPS_SAMPLEFORMATS_SAMPLECONVERTER_C24_H
#define CLODDY_API_HEIGHTMAPS_SAMPLEFORMATS_SAMPLECONVERTER_C24_H
...
// Declare class ::Cloddy::API::Heightmaps::SampleFormats::SampleConverter_C24.
...
namespace Cloddy { namespace API { namespace Heightmaps { namespace SampleFormats
{
  ...
  /*!
   * @brief  A sample format component for diffuse color values stored in three dataset channels (
   *         ie. 24 bits RGB).
   */
  class SampleConverter_C24 : public SampleConverter
  {
  ...
  private:
    ...
    /*!
     * @brief  Creates a new instance of SampleConverter_C24.
     */
    SampleConverter_C24();
     ...
     */
    public: typedef Ptr<SampleConverter_C24> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x460F6DD0;
