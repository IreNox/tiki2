...
#ifndef CLODDY_CORE_MATH_VECTORS_VEC2B_H
#define CLODDY_CORE_MATH_VECTORS_VEC2B_H

#include "CodeX/System.h"

// Declare class ::Cloddy::Core::Math::Vectors::Vec2B.
...
namespace Cloddy { namespace Core { namespace Math { namespace Vectors
{
  ...
  /*!
   * @brief  A two-dimensional vector with 8-bit integer precision.
   * 
   * <pre>
   *     /     \\
   *     |  X  |
  ...
  struct Vec2B : StructType
  {
    ...
    /*!
     * @brief  Creates a new instance of Vec2B.
     * 
     * @param x X-coordinate.
     * @param y Y-coordinate.
     */
    Vec2B(int32 x, int32 y);
     ...
     */
    int32 Cross(const Vec2B& v) const;
     ...
     */
    bool Equals(const Vec2B& v) const;
     ...
     * @return \c true  if both vectors are equal,\c false  if they are not.
     */
    bool Equals(int8 x, int8 y) const;
     ...
     * @return The resulting vector.
     */
    Vec2B ShiftRight(int32 v) const;
