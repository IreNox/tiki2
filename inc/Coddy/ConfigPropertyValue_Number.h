...
#ifndef CLODDY_CORE_CONFIG_CONFIGPROPERTYVALUE_NUMBER_H
#define CLODDY_CORE_CONFIG_CONFIGPROPERTYVALUE_NUMBER_H
...
// Declare class ::Cloddy::Core::Config::ConfigPropertyValue_Number.
...
namespace Cloddy { namespace Core { namespace Config
{
  ...
  /*!
   * @brief  Implementation of the IConfigPropertyValue for NumberType.
   */
  class ConfigPropertyValue_Number : public ConfigPropertyValue
  {
    // ---------------------------------------------------------------------------------------------
    // Public / Attributes
    // ---------------------------------------------------------------------------------------------
  ...
  public:
     ...
     */
    public: typedef Ptr<ConfigPropertyValue_Number> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xC5533B7B;
