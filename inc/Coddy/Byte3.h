...
#ifndef CLODDY_API_VERTEXDATA_BYTE3_H
#define CLODDY_API_VERTEXDATA_BYTE3_H
...
// Declare class ::Cloddy::API::VertexData::Byte3.
...
namespace Cloddy { namespace API { namespace VertexData
{
  ...
  /*!
   * @brief  Data container for application vertex data:three 8-bit integer values.
   */
  class Byte3 : public Byte2
  {
    // ---------------------------------------------------------------------------------------------
    // Public / Attributes
    // ---------------------------------------------------------------------------------------------
  public:
     ...
     */
    public: typedef Ptr<Byte3> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xF86F1AE9;
    ...
    protected: virtual void* TryCast(int typeId)
    {
      ...
      void* ptr;
      if ((ptr = Byte2::TryCast(typeId)) != 0) return ptr;
      return (void*) 0;
    }
  };
