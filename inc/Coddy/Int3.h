...
#ifndef CLODDY_API_VERTEXDATA_INT3_H
#define CLODDY_API_VERTEXDATA_INT3_H
...
// Declare class ::Cloddy::API::VertexData::Int3.
...
namespace Cloddy { namespace API { namespace VertexData
{
  ...
  /*!
   * @brief  Data container for application vertex data:three 32-bit integer values.
   */
  class Int3 : public Int2
  {
    // ---------------------------------------------------------------------------------------------
    // Public / Attributes
    // ---------------------------------------------------------------------------------------------
  public:
     ...
     */
    public: typedef Ptr<Int3> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x76A8A6F6;
    ...
    protected: virtual void* TryCast(int typeId)
    {
      ...
      void* ptr;
      if ((ptr = Int2::TryCast(typeId)) != 0) return ptr;
      return (void*) 0;
    }
  };
