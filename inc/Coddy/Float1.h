...
#ifndef CLODDY_API_VERTEXDATA_FLOAT1_H
#define CLODDY_API_VERTEXDATA_FLOAT1_H
...
// Declare class ::Cloddy::API::VertexData::Float1.
...
namespace Cloddy { namespace API { namespace VertexData
{
  ...
  /*!
   * @brief  Data container for application vertex data:one 32-bit floating-point value.
   */
  class Float1 : public CapacityBase, public virtual IVertexData
  {
    // ---------------------------------------------------------------------------------------------
    // Public / Attributes
    // ---------------------------------------------------------------------------------------------
  public:
     ...
     */
    public: typedef Ptr<Float1> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xF46A51B1;
