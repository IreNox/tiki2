...
#ifndef CLODDY_API_PROCEDURAL_CELLULARCOMBINER_F2_H
#define CLODDY_API_PROCEDURAL_CELLULARCOMBINER_F2_H
...
// Declare class ::Cloddy::API::Procedural::CellularCombiner_F2.
...
namespace Cloddy { namespace API { namespace Procedural
{
  ...
  class CellularCombiner_F2 : public CellularCombiner
  {
    // ---------------------------------------------------------------------------------------------
    // Public / Constructors
    // ---------------------------------------------------------------------------------------------
  public:
    ...
    /*!
     * @brief  Creates a new instance of CellularCombiner_F2.
     */
    CellularCombiner_F2();
  ...
  private:
    ...
    /*!
     * @brief  The GUID that uniquely identifies this type:{A6572F85-180B-4D57-95F6-36B254739E6E}
     */
     ...
     */
    public: typedef Ptr<CellularCombiner_F2> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xC1DDC011;
