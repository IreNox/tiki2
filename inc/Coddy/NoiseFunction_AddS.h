...
#ifndef CLODDY_API_PROCEDURAL_NOISEFUNCTION_ADDS_H
#define CLODDY_API_PROCEDURAL_NOISEFUNCTION_ADDS_H
...
// Declare class ::Cloddy::API::Procedural::NoiseFunction_AddS.
...
namespace Cloddy { namespace API { namespace Procedural
{
  ...
  class NoiseFunction_AddS : public NoiseFunction_FS
  {
  ...
  public:
    ...
    /*!
     * @brief  Creates a new instance of NoiseFunction_AddS.
     */
    NoiseFunction_AddS();
  ...
  private:
    ...
    /*!
     * @brief  The GUID that uniquely identifies this type:{25BF6DB2-C443-40F0-AC5F-9E54662A7A12}
     */
     ...
     */
    NoiseFunction_AddS(INoiseFunction* function, float64 value);
     ...
     */
    public: typedef Ptr<NoiseFunction_AddS> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x1C677544;
