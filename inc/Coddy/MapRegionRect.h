...
#ifndef CLODDY_API_UTIL_MAPREGIONRECT_H
#define CLODDY_API_UTIL_MAPREGIONRECT_H
...
// Declare class ::Cloddy::API::Util::MapRegionRect.
...
namespace Cloddy { namespace API { namespace Util
{
  ...
  /*!
   * @brief  Default implementation of the IMapRegion interface for regions on a rectangular map.
   */
  class MapRegionRect : public MapRegion, public virtual IMapRegionCallback
  {
    // ---------------------------------------------------------------------------------------------
    // Public / Attributes
    // ---------------------------------------------------------------------------------------------
  public:
    ...
    /*!
     * @brief  Creates a new instance of MapRegionRect.
     */
    MapRegionRect();
     ...
     * @return this
     */
    Ptr<MapRegionRect> Add(const Box2I& box);
     ...
     * @return this
     */
    Ptr<MapRegionRect> AddAll(IMapRegion* region);
  ...
  private:
    ...
    /*!
     * @brief  The GUID that uniquely identifies this type:{AC48811E-DE4A-40B4-8A1B-AC0841BE6ABB}
     */
     ...
     */
    public: typedef Ptr<MapRegionRect> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x3B6F2BC2;
