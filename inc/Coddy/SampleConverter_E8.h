...
#ifndef CLODDY_API_HEIGHTMAPS_SAMPLEFORMATS_SAMPLECONVERTER_E8_H
#define CLODDY_API_HEIGHTMAPS_SAMPLEFORMATS_SAMPLECONVERTER_E8_H
...
// Declare class ::Cloddy::API::Heightmaps::SampleFormats::SampleConverter_E8.
...
namespace Cloddy { namespace API { namespace Heightmaps { namespace SampleFormats
{
  ...
  /*!
   * @brief  A sample format component for elevation values stored in one dataset channel (ie. 8 
   *         bits).
   */
  class SampleConverter_E8 : public SampleConverter
  {
  ...
  private:
    ...
    /*!
     * @brief  Creates a new instance of SampleConverter_E8.
     */
    SampleConverter_E8();
     ...
     */
    public: typedef Ptr<SampleConverter_E8> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x669AD694;
