...
#ifndef CLODDY_API_TOOLS_DECOMPRESSTOOL_H
#define CLODDY_API_TOOLS_DECOMPRESSTOOL_H
...
// Declare class ::Cloddy::API::Tools::DecompressTool.
...
namespace Cloddy { namespace API { namespace Tools
{
  ...
  /*!
   * @brief  Decompresses the given input dataset and stores the resulting data in the specified 
   *         output dataset.
   * 
   * The output dataset will have the same size as the input dataset.
   */
  class DecompressTool : public Tool
  {
    // ---------------------------------------------------------------------------------------------
    // Public / Attributes
    // ---------------------------------------------------------------------------------------------
  ...
  private:
    ...
    /*!
     * @brief  The GUID that uniquely identifies this type:{6DBC3DFE-E6E3-4AA1-A169-D0CD3FB100EB}
     */
    ...
    /*!
     * @brief  The actual decompress operation.
     */
     ...
     */
    public: typedef Ptr<DecompressTool> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x4E40FA36;
