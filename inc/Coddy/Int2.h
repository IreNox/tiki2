...
#ifndef CLODDY_API_VERTEXDATA_INT2_H
#define CLODDY_API_VERTEXDATA_INT2_H
...
#include "Cloddy/Int1.h"

// Declare class ::Cloddy::API::VertexData::Int2.
...
namespace Cloddy { namespace API { namespace VertexData
{
  ...
  /*!
   * @brief  Data container for application vertex data:two 32-bit integer values.
   */
  ...
  public:
     ...
     */
    public: typedef Ptr<Int2> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x19501B91;
    ...
    protected: virtual void* TryCast(int typeId)
    {
      ...
      void* ptr;
      if ((ptr = Int1::TryCast(typeId)) != 0) return ptr;
      return (void*) 0;
    }
  };
