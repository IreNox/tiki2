...
#ifndef CLODDY_KERNEL_MESH_SPHERE_H
#define CLODDY_KERNEL_MESH_SPHERE_H
...
// Declare class ::Cloddy::Kernel::Mesh_Sphere.
...
namespace Cloddy { namespace Kernel
{
   ...
   *         the BaseGeometry::BaseGeometry_Sphere base geometry.
   */
  class Mesh_Sphere : public Mesh_Terrain
  {
  ...
  private:
    ...
    /*!
     * @brief  This array holds the spatial structure of the cube mesh layout.
     */
    static const Array<InitialVertex> Vertices;
    
    /*!
     * @brief  This array holds the XDag structure of the cube mesh layout.
     */
    ...
    /*!
     * @brief  Creates a new instance of Mesh_Sphere.
     * 
     ...
     */
    Mesh_Sphere(CloddyKernel* cloddyKernel, int32 refinementLevels, IProvider* provider, IVertexFactory* vertexFactory, IVisibilityCriterion* visibilityCriterion);
     ...
     */
    public: typedef Ptr<Mesh_Sphere> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x1211F0B6;
