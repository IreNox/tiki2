...
#ifndef CLODDY_API_PROCEDURAL_NOISEFUNCTION_ATAN_H
#define CLODDY_API_PROCEDURAL_NOISEFUNCTION_ATAN_H
...
// Declare class ::Cloddy::API::Procedural::NoiseFunction_Atan.
...
namespace Cloddy { namespace API { namespace Procedural
{
  ...
  class NoiseFunction_Atan : public NoiseFunction_F
  {
  ...
  public:
    ...
    /*!
     * @brief  Creates a new instance of NoiseFunction_Atan.
     */
    NoiseFunction_Atan();
  ...
  private:
    ...
    /*!
     * @brief  The GUID that uniquely identifies this type:{4FDE8405-B7BA-4D2D-9558-9DFD42723D4E}
     */
     ...
     */
    NoiseFunction_Atan(INoiseFunction* function);
     ...
     */
    public: typedef Ptr<NoiseFunction_Atan> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x7DBE52CA;
