...
#ifndef CLODDY_API_VERTEXDATA_INT1_H
#define CLODDY_API_VERTEXDATA_INT1_H
...
// Declare class ::Cloddy::API::VertexData::Int1.
...
namespace Cloddy { namespace API { namespace VertexData
{
  ...
  /*!
   * @brief  Data container for application vertex data:one 32-bit integer value.
   */
  class Int1 : public CapacityBase, public virtual IVertexData
  {
    // ---------------------------------------------------------------------------------------------
    // Public / Attributes
    // ---------------------------------------------------------------------------------------------
  public:
     ...
     */
    public: typedef Ptr<Int1> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xBBF7902C;
