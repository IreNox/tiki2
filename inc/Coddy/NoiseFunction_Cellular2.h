...
#ifndef CLODDY_API_PROCEDURAL_NOISEFUNCTION_CELLULAR2_H
#define CLODDY_API_PROCEDURAL_NOISEFUNCTION_CELLULAR2_H
...
// Declare class ::Cloddy::API::Procedural::NoiseFunction_Cellular2.
...
namespace Cloddy { namespace API { namespace Procedural
{
  ...
  class NoiseFunction_Cellular2 : public NoiseFunction
  {
  ...
  public:
    ...
    /*!
     * @brief  Creates a new instance of NoiseFunction_Cellular2.
     */
    NoiseFunction_Cellular2();
  ...
  private:
    ...
    /*!
     * @brief  The GUID that uniquely identifies this type:{485D835A-7E08-4758-ADA5-858E42F206F2}
     */
     ...
     */
    NoiseFunction_Cellular2(ICellularCombiner* combiner);
     ...
     */
    public: typedef Ptr<NoiseFunction_Cellular2> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xDA24BFC0;
