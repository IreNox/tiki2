...
#ifndef CLODDY_API_HEIGHTMAPS_FRACTAL_FRACTALLAYER_DIFFUSE_H
#define CLODDY_API_HEIGHTMAPS_FRACTAL_FRACTALLAYER_DIFFUSE_H
...
// Declare class ::Cloddy::API::Heightmaps::Fractal::FractalLayer_Diffuse.
...
namespace Cloddy { namespace API { namespace Heightmaps { namespace Fractal
{
  ...
  class FractalLayer_Diffuse : public FractalLayer
  {
  ...
  private:
    ...
    FractalLayer_Diffuse(INoiseFunction* a, INoiseFunction* b, INoiseFunction* c, INoiseFunction* d, IFractalDiffuseCombiner* combiner);
     ...
     */
    public: typedef Ptr<FractalLayer_Diffuse> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xDB5E4BF8;
