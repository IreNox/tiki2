...
#ifndef CLODDY_CORE_COLLECTIONS_PREDICATE_OR_H
#define CLODDY_CORE_COLLECTIONS_PREDICATE_OR_H
...
// Declare class ::Cloddy::Core::Collections::Predicate_Or.
...
namespace Cloddy { namespace Core { namespace Collections
{
  ...
  template<class T>
  class Predicate_Or : public PredicateBase<T>
  {
  ...
  private:
    ...
    Predicate_Or(IPredicate<T>* first, IPredicate<T>* second);
     ...
     */
    public: typedef Ptr<Predicate_Or<T> > ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xDD883699;
