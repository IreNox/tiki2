...
#ifndef CLODDY_API_PROCEDURAL_NOISEFUNCTION_COS_H
#define CLODDY_API_PROCEDURAL_NOISEFUNCTION_COS_H
...
// Declare class ::Cloddy::API::Procedural::NoiseFunction_Cos.
...
namespace Cloddy { namespace API { namespace Procedural
{
  ...
  class NoiseFunction_Cos : public NoiseFunction_F
  {
  ...
  public:
    ...
    /*!
     * @brief  Creates a new instance of NoiseFunction_Cos.
     */
    NoiseFunction_Cos();
  ...
  private:
    ...
    /*!
     * @brief  The GUID that uniquely identifies this type:{810EF2F1-30DF-4E19-A3CA-2618609CDE96}
     */
     ...
     */
    NoiseFunction_Cos(INoiseFunction* function);
     ...
     */
    public: typedef Ptr<NoiseFunction_Cos> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xF4EE9711;
