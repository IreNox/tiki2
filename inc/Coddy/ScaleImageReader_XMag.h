...
#ifndef CLODDY_API_IMAGING_SCALEIMAGEREADER_XMAG_H
#define CLODDY_API_IMAGING_SCALEIMAGEREADER_XMAG_H
...
// Declare class ::Cloddy::API::Imaging::ScaleImageReader_XMag.
...
namespace Cloddy { namespace API { namespace Imaging
{
   ...
   *         X-axis.
   */
  class ScaleImageReader_XMag : public ScaleImageReader
  {
  ...
  private:
    ...
    /*!
     * @brief  Creates a new instance of ScaleImageReader_XMag.
     * 
     * @param imageReader The source image reader.
     * @param width Width of the scaled image.
     */
    ScaleImageReader_XMag(IImageReader* imageReader, int32 width);
     ...
     */
    public: typedef Ptr<ScaleImageReader_XMag> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x80F561F6;
