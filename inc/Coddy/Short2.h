...
#ifndef CLODDY_API_VERTEXDATA_SHORT2_H
#define CLODDY_API_VERTEXDATA_SHORT2_H
...
#include "Cloddy/Short1.h"

// Declare class ::Cloddy::API::VertexData::Short2.
...
namespace Cloddy { namespace API { namespace VertexData
{
  ...
  /*!
   * @brief  Data container for application vertex data:two 16-bit integer values.
   */
  class Short2 : public Short1
  {
    // ---------------------------------------------------------------------------------------------
    // Public / Attributes
    // ---------------------------------------------------------------------------------------------
  public:
     ...
     */
    public: typedef Ptr<Short2> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x17276000;
    ...
    protected: virtual void* TryCast(int typeId)
    {
      ...
      void* ptr;
      if ((ptr = Short1::TryCast(typeId)) != 0) return ptr;
      return (void*) 0;
    }
  };
