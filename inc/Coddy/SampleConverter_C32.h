...
#ifndef CLODDY_API_HEIGHTMAPS_SAMPLEFORMATS_SAMPLECONVERTER_C32_H
#define CLODDY_API_HEIGHTMAPS_SAMPLEFORMATS_SAMPLECONVERTER_C32_H
...
// Declare class ::Cloddy::API::Heightmaps::SampleFormats::SampleConverter_C32.
...
namespace Cloddy { namespace API { namespace Heightmaps { namespace SampleFormats
{
  ...
  /*!
   * @brief  A sample format component for diffuse color values stored in four dataset channels (
   *         ie. 32 bits ARGB).
   */
  class SampleConverter_C32 : public SampleConverter
  {
  ...
  private:
    ...
    /*!
     * @brief  Creates a new instance of SampleConverter_C32.
     */
    SampleConverter_C32();
     ...
     */
    public: typedef Ptr<SampleConverter_C32> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xA367F933;
