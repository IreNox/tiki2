...
#ifndef CLODDY_API_PROCEDURAL_NOISEFUNCTION_MAXS_H
#define CLODDY_API_PROCEDURAL_NOISEFUNCTION_MAXS_H
...
// Declare class ::Cloddy::API::Procedural::NoiseFunction_MaxS.
...
namespace Cloddy { namespace API { namespace Procedural
{
  ...
  class NoiseFunction_MaxS : public NoiseFunction_FS
  {
  ...
  public:
    ...
    /*!
     * @brief  Creates a new instance of NoiseFunction_MaxS.
     */
    NoiseFunction_MaxS();
  ...
  private:
    ...
    /*!
     * @brief  The GUID that uniquely identifies this type:{E421A4F9-867A-43E8-8987-6A54EC2E7A10}
     */
     ...
     */
    NoiseFunction_MaxS(INoiseFunction* function, float64 value);
     ...
     */
    public: typedef Ptr<NoiseFunction_MaxS> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xF056728D;
