...
#ifndef CLODDY_CORE_CONFIG_CONFIGPROPERTYVALUE_STRING_H
#define CLODDY_CORE_CONFIG_CONFIGPROPERTYVALUE_STRING_H
...
// Declare class ::Cloddy::Core::Config::ConfigPropertyValue_String.
...
namespace Cloddy { namespace Core { namespace Config
{
  ...
  /*!
   * @brief  Implementation of the IConfigPropertyValue for StringType.
   */
  class ConfigPropertyValue_String : public ConfigPropertyValue
  {
    // ---------------------------------------------------------------------------------------------
    // Public / Attributes
    // ---------------------------------------------------------------------------------------------
  ...
  private:
     ...
     */
    public: typedef Ptr<ConfigPropertyValue_String> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x93615F6D;
