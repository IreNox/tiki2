...
#ifndef CLODDY_API_PROCEDURAL_NOISEFUNCTION_LOGS_H
#define CLODDY_API_PROCEDURAL_NOISEFUNCTION_LOGS_H
...
// Declare class ::Cloddy::API::Procedural::NoiseFunction_LogS.
...
namespace Cloddy { namespace API { namespace Procedural
{
  ...
  class NoiseFunction_LogS : public NoiseFunction_FS
  {
  ...
  public:
    ...
    /*!
     * @brief  Creates a new instance of NoiseFunction_LogS.
     */
    NoiseFunction_LogS();
  ...
  private:
    ...
    /*!
     * @brief  The GUID that uniquely identifies this type:{212A5B1D-DFD6-47DF-B051-CDC10145D1EA}
     */
     ...
     */
    NoiseFunction_LogS(INoiseFunction* function, float64 value);
     ...
     */
    public: typedef Ptr<NoiseFunction_LogS> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x12A6381;
