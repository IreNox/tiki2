...
#ifndef CLODDY_CORE_CONFIG_CONFIGPROPERTYVALUE_STRUCT_H
#define CLODDY_CORE_CONFIG_CONFIGPROPERTYVALUE_STRUCT_H
...
namespace Cloddy { namespace Core { namespace Config { class StructType; } } }

// Declare class ::Cloddy::Core::Config::ConfigPropertyValue_Struct.
...
namespace Cloddy { namespace Core { namespace Config
{
  ...
  /*!
   * @brief  Implementation of the IConfigPropertyValue for StructType.
   */
  class ConfigPropertyValue_Struct : public ConfigPropertyValue, public virtual ICompositeValue
  {
  ...
  private:
    ...
    /*!
     * @brief  Creates a new instance of ConfigPropertyValue_Struct.
     * 
     * @param type The struct type.
     */
    ConfigPropertyValue_Struct(StructType* type);
     ...
     */
    public: typedef Ptr<ConfigPropertyValue_Struct> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x661C19D7;
