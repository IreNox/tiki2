...
#ifndef CLODDY_API_PROCEDURAL_NOISEFUNCTION_POWF_H
#define CLODDY_API_PROCEDURAL_NOISEFUNCTION_POWF_H
...
// Declare class ::Cloddy::API::Procedural::NoiseFunction_PowF.
...
namespace Cloddy { namespace API { namespace Procedural
{
  ...
  class NoiseFunction_PowF : public NoiseFunction_FF
  {
  ...
  public:
    ...
    /*!
     * @brief  Creates a new instance of NoiseFunction_PowF.
     */
    NoiseFunction_PowF();
  ...
  private:
    ...
    /*!
     * @brief  The GUID that uniquely identifies this type:{20DD12FF-2B51-4253-A2AA-EC2AA1AC1848}
     */
     ...
     */
    NoiseFunction_PowF(INoiseFunction* first, INoiseFunction* second);
     ...
     */
    public: typedef Ptr<NoiseFunction_PowF> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xEEBCBB84;
