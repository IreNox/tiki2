...
#ifndef CLODDY_API_HEIGHTMAPS_SAMPLEFORMATS_SAMPLECONVERTER_E24_H
#define CLODDY_API_HEIGHTMAPS_SAMPLEFORMATS_SAMPLECONVERTER_E24_H
...
// Declare class ::Cloddy::API::Heightmaps::SampleFormats::SampleConverter_E24.
...
namespace Cloddy { namespace API { namespace Heightmaps { namespace SampleFormats
{
  ...
  /*!
   * @brief  A sample format component for elevation values stored in three dataset channels (ie. 
   *         24 bits).
   */
  class SampleConverter_E24 : public SampleConverter
  {
  ...
  private:
    ...
    /*!
     * @brief  Creates a new instance of SampleConverter_E24.
     */
    SampleConverter_E24();
     ...
     */
    public: typedef Ptr<SampleConverter_E24> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x460F6E8E;
