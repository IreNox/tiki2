...
#ifndef CLODDY_API_PROCEDURAL_CELLULARCOMBINER_SQUARE_H
#define CLODDY_API_PROCEDURAL_CELLULARCOMBINER_SQUARE_H
...
// Declare class ::Cloddy::API::Procedural::CellularCombiner_Square.
...
namespace Cloddy { namespace API { namespace Procedural
{
  ...
  class CellularCombiner_Square : public CellularCombiner
  {
  ...
  public:
    ...
    /*!
     * @brief  Creates a new instance of CellularCombiner_Square.
     */
    CellularCombiner_Square();
  ...
  private:
    ...
    /*!
     * @brief  The GUID that uniquely identifies this type:{23A659DC-0AE9-4EFF-8E83-4DA199633ED7}
     */
    ...
    /*!
     * @brief  Quadratic coefficient for F1.
     */
    float64 a2;
    ...
    /*!
     * @brief  Quadratic coefficient for F2.
     */
    float64 b2;
    ...
    /*!
     * @brief  Quadratic coefficient for F3.
     */
    float64 c2;
    ...
    /*!
     * @brief  Quadratic coefficient for F4.
     */
    float64 d2;
     ...
     */
    CellularCombiner_Square(float64 a1, float64 b1, float64 c1, float64 d1, float64 a2, float64 b2, float64 c2, float64 d2);
     ...
     */
    public: typedef Ptr<CellularCombiner_Square> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xDE469FF2;
