...
#ifndef CLODDY_API_VERTEXDATA_BYTE2_H
#define CLODDY_API_VERTEXDATA_BYTE2_H
...
#include "Cloddy/Byte1.h"

// Declare class ::Cloddy::API::VertexData::Byte2.
...
namespace Cloddy { namespace API { namespace VertexData
{
  ...
  /*!
   * @brief  Data container for application vertex data:two 8-bit integer values.
   */
  class Byte2 : public Byte1
  {
    // ---------------------------------------------------------------------------------------------
    // Public / Attributes
    // ---------------------------------------------------------------------------------------------
  public:
     ...
     */
    public: typedef Ptr<Byte2> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xF86F1AE8;
    ...
    protected: virtual void* TryCast(int typeId)
    {
      ...
      void* ptr;
      if ((ptr = Byte1::TryCast(typeId)) != 0) return ptr;
      return (void*) 0;
    }
  };
