...
#ifndef CLODDY_CORE_PARSING_RULE_OR_H
#define CLODDY_CORE_PARSING_RULE_OR_H
...
// Declare class ::Cloddy::Core::Parsing::Rule_Or.
...
namespace Cloddy { namespace Core { namespace Parsing
{
  ...
  template<class T>
  class Rule_Or : public RuleBase<T>
  {
  ...
  private:
     ...
     */
    Rule_Or(IRule<T>* first, IRule<T>* second);
     ...
     */
    public: typedef Ptr<Rule_Or<T> > ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x3A157E07;
