...
#ifndef CLODDY_API_VERTEXDATA_LONG1_H
#define CLODDY_API_VERTEXDATA_LONG1_H
...
// Declare class ::Cloddy::API::VertexData::Long1.
...
namespace Cloddy { namespace API { namespace VertexData
{
  ...
  /*!
   * @brief  Data container for application vertex data:one 64-bit integer value.
   */
  class Long1 : public CapacityBase, public virtual IVertexData
  {
    // ---------------------------------------------------------------------------------------------
    // Public / Attributes
    // ---------------------------------------------------------------------------------------------
  public:
     ...
     */
    public: typedef Ptr<Long1> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xB3897A37;
