...
#ifndef CLODDY_API_HEIGHTMAPS_SAMPLEFORMATS_SAMPLECONVERTER_C16_H
#define CLODDY_API_HEIGHTMAPS_SAMPLEFORMATS_SAMPLECONVERTER_C16_H
...
// Declare class ::Cloddy::API::Heightmaps::SampleFormats::SampleConverter_C16.
...
namespace Cloddy { namespace API { namespace Heightmaps { namespace SampleFormats
{
  ...
  class SampleConverter_C16 : public SampleConverter
  {
  ...
  private:
    ...
    /*!
     * @brief  Creates a new instance of SampleConverter_C16.
     */
    SampleConverter_C16();
     ...
     */
    public: typedef Ptr<SampleConverter_C16> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x5E191001;
