...
#ifndef CLODDY_API_HEIGHTMAPS_SAMPLEFORMATS_SAMPLECONVERTER_X32_H
#define CLODDY_API_HEIGHTMAPS_SAMPLEFORMATS_SAMPLECONVERTER_X32_H
...
// Declare class ::Cloddy::API::Heightmaps::SampleFormats::SampleConverter_X32.
...
namespace Cloddy { namespace API { namespace Heightmaps { namespace SampleFormats
{
  ...
  class SampleConverter_X32 : public SampleConverter
  {
  ...
  private:
     ...
     */
    public: typedef Ptr<SampleConverter_X32> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xA367FA3A;
