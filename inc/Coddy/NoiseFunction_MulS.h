...
#ifndef CLODDY_API_PROCEDURAL_NOISEFUNCTION_MULS_H
#define CLODDY_API_PROCEDURAL_NOISEFUNCTION_MULS_H
...
// Declare class ::Cloddy::API::Procedural::NoiseFunction_MulS.
...
namespace Cloddy { namespace API { namespace Procedural
{
  ...
  class NoiseFunction_MulS : public NoiseFunction_FS
  {
  ...
  public:
    ...
    /*!
     * @brief  Creates a new instance of NoiseFunction_MulS.
     */
    NoiseFunction_MulS();
  ...
  private:
    ...
    /*!
     * @brief  The GUID that uniquely identifies this type:{EF575248-BD47-4CD3-858A-72FE1DADF3F8}
     */
     ...
     */
    NoiseFunction_MulS(INoiseFunction* function, float64 value);
     ...
     */
    public: typedef Ptr<NoiseFunction_MulS> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xF3207EDD;
