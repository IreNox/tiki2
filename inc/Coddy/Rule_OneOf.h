...
#ifndef CLODDY_CORE_PARSING_RULE_ONEOF_H
#define CLODDY_CORE_PARSING_RULE_ONEOF_H
...
// Declare class ::Cloddy::Core::Parsing::Rule_OneOf.
...
namespace Cloddy { namespace Core { namespace Parsing
{
  ...
  class Rule_OneOf : public TokenRuleBase<Prm<wchar_t> >
  {
  ...
  private:
    ...
    Rule_OneOf(ISetConst<Prm<wchar_t> >* chars);
     ...
     */
    public: typedef Ptr<Rule_OneOf> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xD340944B;
