...
#ifndef CLODDY_API_VERTEXDATA_SHORT1_H
#define CLODDY_API_VERTEXDATA_SHORT1_H
...
// Declare class ::Cloddy::API::VertexData::Short1.
...
namespace Cloddy { namespace API { namespace VertexData
{
  ...
  /*!
   * @brief  Data container for application vertex data:one 16-bit integer value.
   */
  class Short1 : public CapacityBase, public virtual IVertexData
  {
    // ---------------------------------------------------------------------------------------------
    // Public / Attributes
    // ---------------------------------------------------------------------------------------------
  public:
     ...
     */
    public: typedef Ptr<Short1> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xB9CED49B;
