...
#ifndef CLODDY_API_VERTEXDATA_BYTE1_H
#define CLODDY_API_VERTEXDATA_BYTE1_H
...
// Declare class ::Cloddy::API::VertexData::Byte1.
...
namespace Cloddy { namespace API { namespace VertexData
{
  ...
  /*!
   * @brief  Data container for application vertex data:one 8-bit integer value.
   */
  class Byte1 : public CapacityBase, public virtual IVertexData
  {
    // ---------------------------------------------------------------------------------------------
    // Public / Attributes
    // ---------------------------------------------------------------------------------------------
  public:
     ...
     */
    public: typedef Ptr<Byte1> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0xF86F1AE7;
