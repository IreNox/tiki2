...
#ifndef CLODDY_API_DATASETS_DATASET_1_1_RECT_UNCOMPRESSED_SPARSE_H
#define CLODDY_API_DATASETS_DATASET_1_1_RECT_UNCOMPRESSED_SPARSE_H
...
// Declare class ::Cloddy::API::Datasets::Dataset_1_1_Rect_Uncompressed_Sparse.
...
namespace Cloddy { namespace API { namespace Datasets
{
   ...
   */
  class Dataset_1_1_Rect_Uncompressed_Sparse : public Dataset_1_1_Uncompressed_Sparse
  {
  ...
  private:
    ...
    /*!
     * @brief  Creates a new instance of Dataset_1_1_Rect_Uncompressed_Sparse.
     * 
     * @param datafile The underlying datafile.
     */
    Dataset_1_1_Rect_Uncompressed_Sparse(IDatafile* datafile);
     ...
     */
    public: typedef Ptr<Dataset_1_1_Rect_Uncompressed_Sparse> ptr;
    
    /*!
     * @brief The unique ID of this type.
     */
    public: static const int32 TypeId = 0x82D2E2BA;
